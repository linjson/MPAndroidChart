...
public class ViewPortHandler {
    ...
    public void limitTransAndScale(Matrix matrix, RectF content) {
        ...
        //阻止不再左滑
        float newOffsetX = curTransX <= 0 ? 0 : mTransOffsetX;

        mTransX= Math.min(Math.max(curTransX, maxTransX - newOffsetX), newOffsetX);
...
//    public void getDragOffsetX(){
//        return Utils.convertPixelsToDp(mTransOffsetX);
//    }
    ...
    public float getDragOffsetX() {
        return mTransOffsetX;
    }

    public float getDragOffsetX_DP() {
        return Utils.convertPixelsToDp(mTransOffsetX);
    }
