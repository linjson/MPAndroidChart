...
public abstract class DataRenderer extends Renderer {
    ...
    public void drawValue(Canvas c, IValueFormatter formatter, float value, Entry entry, int dataSetIndex,int stackIndex, float x, float y, int color) {
        mValuePaint.setColor(color);
        c.drawText(formatter.getFormattedValue(value, entry, dataSetIndex,stackIndex, mViewPortHandler), x, y, mValuePaint);
    }
