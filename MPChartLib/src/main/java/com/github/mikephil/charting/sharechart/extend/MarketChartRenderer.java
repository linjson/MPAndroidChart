...
import com.github.mikephil.charting.sharechart.pai.PaiChartRenderer;
import com.github.mikephil.charting.sharechart.sar.SarChartRenderer;
 ...
 */
public class MarketChartRenderer extends DataRenderer {
    ...
    public MarketChartRenderer(MarketChart chart, ChartAnimator animator,
     ...
     */
    protected void createRenderers(MarketChart chart, ChartAnimator animator,
                                   ViewPortHandler viewPortHandler) {

        mRenderers = new ArrayList<>();

        MarketChart.DrawOrder[] orders = chart.getDrawOrder();

        for (MarketChart.DrawOrder order : orders) {

            switch (order) {
                case BAR:
                    if (chart.getBarData() != null)
                        mRenderers.add(new MarketBarChartRenderer(chart, animator, viewPortHandler));
                    break;
                ...
                case CANDLE:
                    if (chart.getCandleData() != null)
                        mRenderers.add(new MarketKlineChartRender(chart, animator,
                                viewPortHandler));
                    break;
                case POINT:
                    if (chart.getScatterData() != null)
                        mRenderers.add(new PaiChartRenderer(chart, animator, viewPortHandler));
                    break;
                case SAR:
